...
const Products = () => {
  ...
  return (
    <>
      <SeoData title="All Products | ActiveAttire" />
        ...
        <div className="flex gap-3 m-auto mt-2 sm:mt-2 sm:mx-3 ">
          ...
          <div className="relative flex-1 ">
            ...
            {!loading && products?.length === 0 && (
              <div className="flex flex-col items-center justify-start gap-3 bg-white shadow-sm rounded-2xl p-6 sm:p-16 sm:min-h-[750px] ">
                <img
                  draggable="true"
                  className="object-contain w-1/2 mt-10 h-44" 
                  src={noResultsImage}
            ...
            {loading ? (
              ...
              products?.length !== 0 && (
                <div className="flex flex-col items-center justify-center w-full gap-2 pb-4 overflow-hidden bg-white rounded-2xl">
